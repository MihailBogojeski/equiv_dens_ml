...
for i, calc_key in enumerate(mono1.keys()):
    ...
    print('unique atoms 1', np.unique(z1))
    print('unique atoms 2', np.unique(z2))
    coord_params = None
    ...
    np.save('results/ml_mbd_dict_1_' + target + '.npy', ml_mbd_dict_1, allow_pickle=True)
    np.save('results/ml_mbd_dict_2_' + target + '.npy', ml_mbd_dict_2, allow_pickle=True)
