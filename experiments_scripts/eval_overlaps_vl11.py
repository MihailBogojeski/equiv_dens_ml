...
"""
with open("/home/ml-dft/equiv_dens/datasets/vL11_monomers.pickle", 'rb') as f:
...
for count, calc_key in enumerate(mono1.keys()):
    ...
    if integral_constraint:
        ...
        norm_str = '_no_norm'
    np.save('results/' + file[5:-4] + '_ovlps_ml' + norm_str + '_vL11.npy', ovlps_ml, allow_pickle=True)
