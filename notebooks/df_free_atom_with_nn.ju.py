...
df_sph_coeffs = orbitals.vector_to_coeffs_dict({'spherical_coeffs': samp_df['df_coeffs']},
                                               dataset.orbital_basis_num, samp_df['atom_numbers'], radial_coeffs=True,
                                               convert_to_equiv_dens=True, radial_basis=dataset.radial_coeffs)

df_coeffs_dict['spherical_coeffs'] = df_sph_coeffs['spherical_coeffs']
df_coeffs_dict['radial_scale'] = df_sph_coeffs['radial_scale']
df_coeffs_dict['radial_width'] = df_sph_coeffs['radial_width']
