...
def calculate_sapt0_ml(res_1, res_2, res, orbital_basis_num, precalc_basis=True):
    ...
    sapt0_ml_efield12, sapt0_ml_efield21 = calculate_efield(res_1, mol_1, auxmol_ml_1, df_coeffs_ml_1,
...
def calculate_efield(res_1, mol_1, auxmol_ml_1, df_coeffs_ml_1,
                     res_2, mol_2, auxmol_ml_2, df_coeffs_ml_2):
    elefs_ml_12 = []
    elefs_ml_21 = []
    alpha = 1000000
