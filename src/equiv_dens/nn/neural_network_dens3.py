...
class NeuralNetwork(nn.Module):
    def __init__(self,
                 ...
                 num_occupied_orbitals=5,  # number of occupied orbitals
        ...
        if load_from is not None:
            ...
            num_occupied_orbitals = saved_state['num_occupied_orbitals']
        ...
        self.num_occupied_orbitals = num_occupied_orbitals
    ...
    def save(self, PATH):
        torch.save({
            ...
            'num_occupied_orbitals': self.num_occupied_orbitals,
