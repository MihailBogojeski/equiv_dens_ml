...
print("---------------------------------")
dataset = HamiltonianDataset('../../../datasets/h2o_pbe-def2svp_4999.db')
print(len(dataset))
print(dataset.database.Z)

splits = seeded_random_split(dataset, [500, 500, 3999], seed=0)
...
for split_name, split_data in zip(split_names, splits):
    ...
    for batch in tqdm.tqdm(data_loader):
        ...
        # full_hamiltonian, overlap
        # mo_coeff, mo_energies as EVD of HM and overlap
        # mo_occ is vector of n//2 twos rest 0
        # dm from mf.make_rdm1(mo_coeff, mo_occ)
