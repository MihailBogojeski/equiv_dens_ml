...
np.save('datasets/' + basis + '_orbital_basis' + df_str + '.npy', ao_basis, allow_pickle=True)
np.save('datasets/' + basis + '_radial_coeffs' + df_str + '.npy', ao_coeffs, allow_pickle=True)

ao_basis_old = np.load('datasets/' + basis + '_orbital_basis' + df_str + '.npy', allow_pickle=True).item()
print('ao_basis', ao_basis_old)
ao_coeffs_old = np.load('datasets/' + basis + '_radial_coeffs' + df_str + '.npy', allow_pickle=True).item()
