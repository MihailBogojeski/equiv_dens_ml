...
def parse_command_line_arguments():
    ...
    args_training.add_argument("--lookahead_k", metavar='INT', type=int, default=5, help="Lookahead uses k steps (-1 -> no Lookahead is used)")
    ...
    args_training.add_argument("--epsilon", metavar='FLOAT', type=float, default=1e-8, help="epsilon for the optimizer (only relevant for Adam/AMSGrad)")
